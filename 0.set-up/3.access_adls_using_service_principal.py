...
# Both are copied from Azure Databricks >microsoft Entra ID>  manage > App Registration > formula1-app_hamza
client_secret = "tPU8Q~cy1mwkSkqe0cEFVUeTqF6YfKLHiJoYIbC1"
# Copied from Azure Databricks >microsoft Entra ID> formula1-app_hamza (a Service Principal) > manage > certificates and Secrets > copy the value not secreat ID
